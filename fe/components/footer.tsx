export const Footer = () => {
  return <>
    <footer className="bg-pink-100/90 text-neutral-600 flex py-2 px-2 border-t border-neutral-100/70 justify-center items-center">
      <a
      ...
      >
        Powered by{' '}
        <svg className="h-4 ml-2 fill-neutral-600" role="img" aria-label="Vercel Inc." height="20" viewBox="0 0 283 64">
